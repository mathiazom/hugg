...
> API project for hugg, built with .NET

<img src="nugg.png" alt="nugg" width="200"/>

Based on the [Variant .NET template](https://github.com/varianter/dotnet-template) using the following technologies:
